          ...
          children: [
            Container(
              child: Hero(
                ...
                child: CircleAvatar(
                  radius: 100.0,
                  backgroundImage: NetworkImage('https://media.discordapp.net/attachments/708078392376950807/839709195166941184/Picture3.jpg'),
                ),
              ),
            ),
            FutureBuilder(
                      ...
                      children: <Widget>[
                        ...
                        FadeAnimation(
                          Card(
                            margin: EdgeInsets.symmetric(vertical: 5.0, horizontal: 20.0),
                            child: ListTile(
                              leading: Icon(Icons.alternate_email, color: Colors.redAccent),
                              title: Text(
                                items.email!,
                                style: GoogleFonts.varelaRound(
                                    color: Colors.black, fontSize: 18)
